...
$(document).ready(function () {
  ...
  function submitUpdateUserDetailsForm(e, formElement) {
    ...
    if (!data.licenseNumber)
      error.push("<li>Driver's license number is required</l1>");
  ...
  $("#logout-button-partner").on("click", function (e) {
    e.preventDefault();
    logout();
  });
});
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>this is the code for customize credit card option 25-03-2022<<<<<<<<<<<<<<<<<<<<<
