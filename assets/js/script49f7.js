!(function (t) {
  ...
  if (s.length > 0) {
    ...
    e.scroll(function () {
      var t = e.scrollTop(),
        a = l.height();
      t > c.top
        ? s.hasClass("has-fixed") ||
          (s.addClass("has-fixed"), r.css("padding-top", a))
        : s.hasClass("has-fixed") &&
          (s.removeClass("has-fixed"), r.css("padding-top", 0));
    });
  }
  ...
  function w(t) {
    n < 991
      ? t.delay(500).addClass("navbar-mobile")
      : t.delay(500).removeClass("navbar-mobile");
  }
  C.length > 0 &&
    ...
    S.length > 0 &&
      S.each(function () {
        t(this).parent().addClass("has-timepicker"),
          t(this).timepicker({ timeFormat: "HH:mm", interval: 15 });
      }),
        ...
        datasets: [
          {
            ...
            lineTension: 0,
            backgroundColor: [
              window.pieColors.pieColor1,
              window.pieColors.pieColor2,
            ],
            borderColor: "#fff",
            borderWidth: 2,
    ...
    new Chart(N, {
      ...
      options: {
        ...
        scales: {
          yAxes: [
            {
              ticks: { beginAtZero: !0, fontSize: 10, fontColor: "#9eaecf" },
              gridLines: {
                color: "transparent",
                tickMarkLength: 0,
          ...
          xAxes: [
            {
              ticks: { fontSize: 9, fontColor: "#9eaecf", source: "auto" },
              gridLines: {
                color: "transparent",
                tickMarkLength: 7,
                zeroLineColor: "transparent",
  ...
  //       $.removeClass("active"),
  //       Y.addClass("active"),
  //       null == t && Cookies.set("twz-offer", "true", { expires: 1, path: "" }),
  //       !1
  //     );
  //   }),
  //   e.on("load", function () {
...
//Get the button
var scrollToTop = document.querySelector(".scroll-to-top-master-wrapper");
...
let topbarNavMobileMenu = document.querySelector('.topbar-nav.d-lg-none');
topbarNavMobileMenu.addEventListener('click', function(){
  document.querySelector('.navbar-menu').classList.toggle('active');
});

document.body.addEventListener('click', function(e){
  if (!(e.target.closest(".topbar-nav.d-lg-none"))) {
    document.querySelector('.navbar-menu').classList.remove('active');
  }
});


if(document.getElementsByClassName('embeded-code-div').length > 0){
  let embededCodeDiv = document.querySelector('.embeded-code-div');
  let embededCodeDivWrapper = document.querySelector('.embeded-code-div-wrapper');

  embededCodeDivWrapper.addEventListener('mouseenter', function(){
    embededCodeDiv.style.cssText += "opacity: 0.2; transition: 0.3s;"
    document.querySelector(".embeded-code-div-wrapper span").innerText = "CLICK TO COPY";
    document.querySelector(".embeded-code-div-wrapper span").style.cssText += "display: block;"
  });

  embededCodeDivWrapper.addEventListener('mouseleave', function(){
    if(document.querySelector(".embeded-code-div-wrapper span").innerText == "COPIED!"){
      setTimeout(function () {
        document.querySelector(".embeded-code-div-wrapper span").style.cssText += "display: none;"
        embededCodeDiv.style.cssText += "opacity: 1; transition: 0.3s;"
      }, 4000);
    } 

    if(document.querySelector(".embeded-code-div-wrapper span").innerText == "CLICK TO COPY"){
        document.querySelector(".embeded-code-div-wrapper span").style.cssText += "display: none;"
        embededCodeDiv.style.cssText += "opacity: 1; transition: 0.3s;"
    }
    
  });
  embededCodeDivWrapper.addEventListener('click', function(){
    document.querySelector(".embeded-code-div-wrapper span").innerText = "COPIED!";
    navigator.clipboard.writeText(embededCodeDiv.innerText);
      setTimeout(function () {
        document.querySelector(".embeded-code-div-wrapper span").style.cssText += "display: none;"
        embededCodeDiv.style.cssText += "opacity: 1; transition: 0.3s;"
        }, 4000);
