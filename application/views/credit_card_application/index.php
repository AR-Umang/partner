...
<div id="registrationID">
    ...
    <div class="afterSubmitBtn">
        <!-- <button id="goToHomeAgain">Go To Home</button>
        <button id="goToFormAgain">Submit Another Application</button> -->
        <button id="goToFormAgain">Back to Home</button>
    </div>
</div>
...
<form id="regForm" enctype="multipart/form-data" style="position: relative;">
    ...
    <div class="tab first-page">
        <div class="widget-credit-card-application__heading">Business Information</div>
        ...
        <div class="input-tab-row">
            ...
            <p>
                ...
                <span class="upload-span">
                    ...
                    <button type="button" id="uploadEINLetter" class="common-upload-button">&#8682;</button>
                </span>
                <progress min="0" max="100" value="0" id="EINProgressBar"></progress>
                <span class="progress-indicator"></span>
                <span id="EINLetterStatus"></span>
            </p>
            <p>
                ...
                <span class="upload-span">
                    ...
                    <button type="button" id="uploadArticle" class="common-upload-button">&#8682;</button>
                </span>
                <progress min="0" max="100" value="0" id="aricleProgressBar"></progress>
                <span class="progress-indicator"></span>
    ...
    <div class="tab">
        <div class="widget-credit-card-application__heading">Ownership and Principals Information</div>
        <div class="input-tab-row">
            <p>
        ...
        <div class="input-tab-row">
            <p>
                <label for="">Gender<span class="form__star">*</span></label>
                <select id="partnerGender" class="select-box input-field" placeholder="State" oninput="this.className = 'input-field'">
        ...
        <div class="input-tab-row">
            <p>
                ...
                <span class="upload-span">
                    ...
                    <button type="button" id="uploadSSNCard" class="common-upload-button">&#8682; </button>
                </span>
                <progress min="0" max="100" value="0" id="SSNCardProgressBar"></progress>
                <span class="progress-indicator"></span>
                <span id="SSNCardStatus"></span>
                <span></span>
            </p>
            <p>
                ...
                <span class="upload-span">
                    ...
                    <button type="button" id="uploadFrontDrivingLicense" class="common-upload-button">&#8682;</button>
                </span>
                <progress min="0" max="100" value="0" id="FrontDrivingLicenseProgressBar"></progress>
                <span class="progress-indicator"></span>
                <span id="FrontDrivingLicenseStatus"></span>
                <span></span>
            </p>
            <p>
                ...
                <span class="upload-span">
                    ...
                    <button type="button" id="uploadBackDrivingLicense" class="common-upload-button">&#8682;</button>
                </span>
                <progress min="0" max="100" value="0" id="BackDrivingLicenseProgressBar"></progress>
                <span class="progress-indicator"></span>
                <span id="BackDrivingLicenseStatus"></span>
                <span></span>
            </p>
        </div>
        <div style="display: flex; margin-top:50px; margin-bottom:50px;">
            <div style="margin-right: 50px; color:#09355c; font-weight:500;">
                <h3>Have Insurance?</h3>
            </div>
            <div style="display: flex; margin-top:8px; justify-content:space-around;">
                <p style="display:flex; margin-right:10px;">
                    <input style="width:30px;" class="input-field" id="haveInsurance" type="radio" placeholder="" oninput="this.className = 'input-field'" name="Insurance" value="Yes">
                    <label style="margin-left:1%;" for="haveInsurance">Yes</label>
                </p>
                <p style="display:flex">
                    <input style="width:30px;" class="input-field" id="haveNoInsurance" type="radio" placeholder="" oninput="this.className = 'input-field'" name="Insurance" value="No">
                    <label style="margin-left:1%;" for="haveNoInsurance">No</label>
                </p>
            </div>
        </div>
...
<script>
    ...
    function gettingFormData() {
        let partnerBusinessCapitalApplicationForm = {
            ...
            "haveInsurance": document.querySelector("input[name='Insurance']:checked").value,
            "gender": document.querySelector("#partnerGender").value
        };
    ...
    const partnerDataUpload = event => {
        ...
        // console.log(document.querySelector("input[name='Insurance']:checked").value);
        ...
        fetch('https://artechnity.in/track/index.php/api/zapierData', {
                ...
                headers: {
                    ...
                    'attachment': localStorage.getItem("jsonDataKey")
                },
            })
            .then(response => {
    ...
    // this is the code for upload the files and the progress bar is also appeared in the screen 
    localStorage.setItem("jsonDataKey", "Dummy");



    const uploadEinLetter = event => {
        document.querySelector("#uploadEINLetter").addEventListener('click', (e) => {
            let ein_letter = document.querySelector("#partnerEIN");
            if (ein_letter.files[0] != undefined) {
                ...
                xhr.onreadystatechange = () => {
                    if (xhr.status == 200) {
                        ...
                        if (xhr.responseText) {
                            // console.log("1");
                            let jsonDataKey = JSON.parse(xhr.responseText).image;
                            localStorage.setItem("jsonDataKey", JSON.stringify(jsonDataKey));
                            // console.log(localStorage.getItem("jsonDataKey"));
                        }
                ...
                xhr.upload.onloadstart = e => {
                    document.querySelector("#EINProgressBar").style.cssText += "display:block;";
                    document.querySelector("#EINProgressBar").value = 0;
                    document.querySelector("#EINProgressBar").max = e.total;
                }

                xhr.upload.onprogress = e => {
                    document.querySelector("#EINProgressBar").value = e.loaded;
                    document.querySelector("#EINProgressBar").max = e.total;

                };

                xhr.upload.onloadend = () => {
                    document.querySelector("#EINProgressBar").style.cssText += "display:none;";
                    document.querySelector("#EINLetterStatus").style.cssText += "font-size:10px; color:green;";
                    document.querySelector("#EINLetterStatus").innerText = "File Uploaded Successfully";

                    // console.log(jsonDataKey);

                }
                xhr.open('POST', 'https://artechnity.in/track/index.php/api/attachement', true);
                xhr.setRequestHeader('imagetype', 'EIN');
                xhr.setRequestHeader('JsonData', `${localStorage.getItem("jsonDataKey")}`);
    ...
    const uploadArticle = event => {
        document.querySelector("#uploadArticle").addEventListener('click', (e) => {
            let artice = document.querySelector("#partnerIncorporationArticles");
            if (artice.files[0] != undefined) {
                let xhr = new XMLHttpRequest();
                const formdata = new FormData();

                formdata.append('image', artice.files[0])
                ...
                xhr.upload.onloadstart = e => {
                    document.querySelector("#aricleProgressBar").style.cssText += "display:block;";
                    document.querySelector("#aricleProgressBar").value = 0;
                    document.querySelector("#aricleProgressBar").max = e.total;
                }

                xhr.upload.onprogress = e => {
                    document.querySelector("#aricleProgressBar").value = e.loaded;
                    document.querySelector("#aricleProgressBar").max = e.total;

                };

                xhr.upload.onloadend = () => {
                    document.querySelector("#aricleProgressBar").style.cssText += "display:none;";
                    document.querySelector("#articleStatus").style.cssText += "font-size:10px; color:green;"
                    document.querySelector("#articleStatus").innerText = "File Uploaded Successfully";

                    // console.log(jsonDataKey);

                }
                xhr.open('POST', 'https://artechnity.in/track/index.php/api/attachement', true);
                xhr.setRequestHeader('imagetype', 'Articles');
                xhr.setRequestHeader('JsonData', `${localStorage.getItem("jsonDataKey")}`);
    ...
    const uploadSSNCard = event => {
        document.querySelector("#uploadSSNCard").addEventListener('click', (e) => {
            let SSNCard = document.querySelector("#partnerCustomerInformationSSNCard");
            if (SSNCard.files[0] != undefined) {
                let xhr = new XMLHttpRequest();
                const formdata = new FormData();

                formdata.append('image', SSNCard.files[0])
                ...
                xhr.upload.onloadstart = e => {
                    document.querySelector("#SSNCardProgressBar").style.cssText += "display:block;";
                    document.querySelector("#SSNCardProgressBar").value = 0;
                    document.querySelector("#SSNCardProgressBar").max = e.total;
                }

                xhr.upload.onprogress = e => {
                    document.querySelector("#SSNCardProgressBar").value = e.loaded;
                    document.querySelector("#SSNCardProgressBar").max = e.total;

                };

                xhr.upload.onloadend = () => {
                    document.querySelector("#SSNCardProgressBar").style.cssText += "display:none;";
                    document.querySelector("#SSNCardStatus").style.cssText += "font-size:10px; color:green;";
                    document.querySelector("#SSNCardStatus").innerText = "File Uploaded Successfully";

                    // console.log(jsonDataKey);

                }
                xhr.open('POST', 'https://artechnity.in/track/index.php/api/attachement', true);
                xhr.setRequestHeader('imagetype', 'SSNCard');
                xhr.setRequestHeader('JsonData', `${localStorage.getItem("jsonDataKey")}`);
    ...
    const uploadDrivingLicenseFront = event => {
        document.querySelector("#uploadFrontDrivingLicense").addEventListener('click', (e) => {
            let DL_Front = document.querySelector("#partnerCustomerInformationLicenseFront");
            if (DL_Front.files[0] != undefined) {
                let xhr = new XMLHttpRequest();
                const formdata = new FormData();

                formdata.append('image', DL_Front.files[0])
                ...
                xhr.upload.onloadstart = e => {
                    document.querySelector("#FrontDrivingLicenseProgressBar").style.cssText += "display:block;";
                    document.querySelector("#FrontDrivingLicenseProgressBar").value = 0;
                    document.querySelector("#FrontDrivingLicenseProgressBar").max = e.total;
                }

                xhr.upload.onprogress = e => {
                    document.querySelector("#FrontDrivingLicenseProgressBar").value = e.loaded;
                    document.querySelector("#FrontDrivingLicenseProgressBar").max = e.total;

                };

                xhr.upload.onloadend = () => {
                    document.querySelector("#FrontDrivingLicenseProgressBar").style.cssText += "display:none;";
                    document.querySelector("#FrontDrivingLicenseStatus").style.cssText += "font-size:10px; color:green;";
                    document.querySelector("#FrontDrivingLicenseStatus").innerText = "File Uploaded Successfully";

                    // console.log(jsonDataKey);

                }
                xhr.open('POST', 'https://artechnity.in/track/index.php/api/attachement', true);
                xhr.setRequestHeader('imagetype', 'DL_Front');
                xhr.setRequestHeader('JsonData', `${localStorage.getItem("jsonDataKey")}`);
    ...
    uploadDrivingLicenseFront()




    const uploadDrivingLicenseBack = event => {
        document.querySelector("#uploadBackDrivingLicense").addEventListener('click', (e) => {
            let DL_Back = document.querySelector("#partnerCustomerInformationLicenseBack");
            if (DL_Back.files[0] != undefined) {
                let xhr = new XMLHttpRequest();
                const formdata = new FormData();

                formdata.append('image', DL_Back.files[0])
                ...
                xhr.upload.onloadstart = e => {
                    document.querySelector("#BackDrivingLicenseProgressBar").style.cssText += "display:block;";
                    document.querySelector("#BackDrivingLicenseProgressBar").value = 0;
                    document.querySelector("#BackDrivingLicenseProgressBar").max = e.total;
                }

                xhr.upload.onprogress = e => {
                    document.querySelector("#BackDrivingLicenseProgressBar").value = e.loaded;
                    document.querySelector("#BackDrivingLicenseProgressBar").max = e.total;

                };

                xhr.upload.onloadend = () => {
                    document.querySelector("#BackDrivingLicenseProgressBar").style.cssText += "display:none;";
                    document.querySelector("#BackDrivingLicenseStatus").style.cssText += "font-size:10px; color:green;";
                    document.querySelector("#BackDrivingLicenseStatus").innerText = "File Uploaded Successfully";

                    // console.log(jsonDataKey);

                }
                xhr.open('POST', 'https://artechnity.in/track/index.php/api/attachement', true);
                xhr.setRequestHeader('imagetype', 'DL_Back');
                xhr.setRequestHeader('JsonData', `${localStorage.getItem("jsonDataKey")}`);
